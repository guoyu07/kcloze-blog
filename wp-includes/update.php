...
function wp_version_check() {
	...
	$url = "http://wp4saeapi.sinaapp.com/core/version-check/1.5/?version=$wp_version&php=$php_version&locale=$locale&mysql=$mysql_version&local_package=$local_package&blogs=$num_blogs&users={$user_count['total_users']}&multisite_enabled=$multisite_enabled";
...
function wp_update_themes( ) {
	...
	$raw_response = wp_remote_post( 'http://wp4seaapi.sinaapp.com/themes/update-check/1.0/', $options );
